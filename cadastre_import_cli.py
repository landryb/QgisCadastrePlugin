 ...
 ***************************************************************************/
"""
__package__ = 'cadastre_import_cli'
...
class cadastreImport(QObject):
    ...
    def endImport(self):
        ...
        self.qc.updateLog('Suppression des données temporaires')
        self.updateProgressBar()
        tempFolderList = [
            self.pScriptDir,
            self.edigeoPlainDir,
    ...
    def importAllEdigeoToDatabase(self):
        ...
        if self.go:
            ...
            print (f"{self.totalSteps} thf files to go")
            for thf in thfList:
#                print (f"importing thf {thf}")
        ...
        if self.go:
            ...
            print (f"{self.totalSteps} vec files to go")
            for vec in vecList:
